...
// const uri = `mongodb://${MONGODB_USER}:${MONGODB_PASSWORD}@localhost:27017`
const uri = 'mongodb://localhost:27017/workout_lol';

const client = new MongoClient(uri, { useNewUrlParser: true, useUnifiedTopology: true, serverApi: ServerApiVersion.v1 })

const DATABASE = 'workout_lol'
...
export const getAllExercises = async () => {
  let result = []
  try {
    const dbClient = await connectDb().then(e => console.log('e', e, 'connected')).catch(err => console.log('err', err))
