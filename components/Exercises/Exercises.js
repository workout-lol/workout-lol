                ...
                <div style={{width: '100%'}}>
                  ...
                  >
                    {workout.map((exercise, index) => (
                      <Timeline.Item
                        key={exercise._id}
                        sx={{ padding: isDragging ? "0.1rem" : "auto", paddingLeft: "1.5rem !important"}}
                        bullet={
                      ...
                      >
                        ...
                        >
                          {(draggableProvided, snapshot) => {
                            return (
                            <Flex
                              sx={{...draggingStyle(snapshot.isDragging)}}
                            ...
                            >
                              ...
                              <Flex mr="xl" mb={{ base: "sm", xs: 0 }} align="center" justify="center">
                                <Flex {...draggableProvided.dragHandleProps} justify="center" mr="xs">
