...
const PUBLIC_WORKOUT_COLLECTION = 'public_workouts'
...
export const createPublicWorkout = async (workout) =>
  await create(PUBLIC_WORKOUT_COLLECTION, workout)
export const getPublicWorkoutByQuery = async (query) =>
  await findByQuery(PUBLIC_WORKOUT_COLLECTION, query)
