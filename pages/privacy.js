  ...
  return <Layout>
    ...
    <Text>
      <p>Effective date: January 15, 2020</p>
        ...
        <h2>Use of Data</h2>
        <p>
            Vincent Will uses the collected data for various
            purposes:
        </p>
        <ul>
        ...
        <p>
          ...
          data, including Personal Data, to Germany and process it
          there.
        </p>
        <p>
        ...
        <p>
          Vincent Will will take all steps reasonably necessary to
        ...
        <p>
            Vincent Will may disclose your Personal Data in the good
