...
export const createExercise = async (exercise) => await create(EXERCISE_COLLECTION, exercise)
export const createUser = async (user) => await create(USER_COLLECTION, user)

export const updateUserByQuery = async (query, update) => await updateByQuery(USER_COLLECTION, query, update)
export const updateExercise = async ({ _id, update }) => await updateByQuery(EXERCISE_COLLECTION, { _id }, update)

export const getUserByQuery = async (query, projection) => await findByQuery(USER_COLLECTION, query, projection)
export const getExercisesByQuery = async (query) => await findByQuery(EXERCISE_COLLECTION, query)
